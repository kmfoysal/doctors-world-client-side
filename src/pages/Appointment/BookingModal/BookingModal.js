...
const BookingModal = ({openBooking, handleBookingClose,booking, date, setAppointmentSuccessMsg}) => {
    ...
    const handleBookingSubmit = e =>{ 
        ...
        // Send to the Server 
        fetch('https://thawing-tor-57287.herokuapp.com/appointments', {
            method:'POST',
            headers:{
